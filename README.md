...
- 🛠️ Experienced with **React**, **Next.js**, **Node.js**, **Typescript**, **JavaScript**, **HTML**, **CSS**, **Java**, **C#**, **Python**, **.NET MAUI**, and **ASP.NET**.
...
### [Raspberry Pi Temperature & Humidity Simulation](https://github.com/VilleHuupponen/Raspberry-Pi-Temperature-Humidity-Simulation)
A simulated Raspberry Pi project that generates temperature and humidity data using virtual sensors. Data is stored locally in SQLite and optionally sent to Azure IoT Hub. Built in Python.

**What I Learned:**
- Developed skills in multiprocessing and sensor simulation in Python
- Worked with local databases (SQLite) and cloud integration (Azure IoT Hub)
- Managed environment variables securely using `python-dotenv`
